...
int main(int argc, char **argv)
{
  ...
  //---------------------------------------
  // Stellar SfM reconstruction process
  //---------------------------------------

  openMVG::system::Timer timer;
  StellarSfMReconstructionEngine sfmEngine(
    sfm_data,
    sOutDir,
  ...
  {
    std::cout << std::endl << " Total Stellar-Sfm took (s): " << timer.elapsed() << std::endl;
