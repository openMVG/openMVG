...
int main(int argc, char** argv)
{
  ...
  desc.add_options()
          ...
          ("descriptorPath", po::value<std::string>(&descriptorsFolder)->required(), "Folder containing the .desc [for the older version of openMVG it is the list.txt].")
          ...
          ("calibration", po::value<std::string>(&rigCalibPath)->required(), "The file containing the calibration data for the file (subposes)")
  // parameters for voctree localizer
...
#endif
#if HAVE_ALEMBIC
          ("export,e", po::value<std::string>(&exportFile)->default_value(exportFile), "If Alambic is enable it will export an .abc file of the scene with the same name")
#endif
          ;
