...
int main(int argc, char** argv)
{
  ...
  desc.add_options()
        ...
        ("sfmdata,d", po::value<std::string>(&sfmFilePath)->required(),
            "The sfm_data.json kind of file generated by OpenMVG [it could be "
            "also a bundle.out to use an older version of OpenMVG]")
        ("siftPath,s", po::value<std::string>(&descriptorsFolder)->required(),
            "Folder containing the .desc [for the older version of openMVG it is "
            "the list.txt].")
        ("mediapath,m", po::value<std::string>(&mediaPath)->required(),
        ...
        ("calibration,c", po::value<std::string>(&rigCalibPath)->required(), 
          "The file containing the calibration data for the rig (subposes)")
// parameters for voctree localizer
        ("voctree,t", po::value<std::string>(&vocTreeFilepath),
