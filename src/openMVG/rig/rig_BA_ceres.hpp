...
{
public :
  ResidualErrorSecondaryCameraFunctor(const cameras::Pinhole_Intrinsic_Radial_K3 & intrinsics, const openMVG::Vec2 & x, const openMVG::Vec3 & X) // const double* const pos_2dpoint
  {
    // Set the intrinsics
     _K = intrinsics.K();
