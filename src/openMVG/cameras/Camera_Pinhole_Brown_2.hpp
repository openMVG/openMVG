#ifndef OPENMVG_CAMERAS_CAMERA_PINHOLE_BROWN_2_HPP
#define OPENMVG_CAMERAS_CAMERA_PINHOLE_BROWN_2_HPP
...
*/
class Pinhole_Intrinsic_Brown_T2_2 : public Pinhole_Intrinsic_2
{
  using class_type = Pinhole_Intrinsic_Brown_T2_2;
  ...
  public:
    ...
    * @param focalx Focal distance x (in pixel)
    * @param focaly Focal distance y (in pixel)
    ...
    */
    Pinhole_Intrinsic_Brown_T2_2(
      int w = 0, int h = 0,
      double focalx = 0.0, double focaly = 0.0,
      double ppx = 0, double ppy = 0,
      double k1 = 0.0, double k2 = 0.0, double k3 = 0.0,
      double t1 = 0.0, double t2 = 0.0 )
      : Pinhole_Intrinsic_2( w, h, focalx, focaly, ppx, ppy ),
    ...
    * @retval PINHOLE_CAMERA_BROWN_2
    */
    EINTRINSIC getType() const override
    {
      return PINHOLE_CAMERA_BROWN_2;
    }
    ...
    */
    ...
    {
      std::vector<double> params = Pinhole_Intrinsic_2::getParams();
    ...
    */
    bool updateFromParams( const std::vector<double> & params ) override
    {
      if ( params.size() == 9 )
      {
        *this = Pinhole_Intrinsic_Brown_T2_2(
                  w_, h_,
                  params[0], params[1], params[2], params[3], // focalx, focaly, ppx, ppy
                  params[4], params[5], params[6], // K1, K2, K3
                  params[7], params[8] ); // T1, T2
        return true;
      }
      else
      {
...
#endif // #ifndef OPENMVG_CAMERAS_CAMERA_PINHOLE_BROWN_2_HPP
