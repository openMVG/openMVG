    ...
    else
    {
      ...
      switch (_camType)
      {
        ...
        case PINHOLE_CAMERA_BROWN:
          //TODO: extract tangential distortion coefficients from K_ and initialize for PINHOLE_CAMERA_BROWN
          tiny_scene.intrinsics[view_I->id_intrinsic] =
            std::make_shared<Pinhole_Intrinsic_Brown_T2>
            (view_I->ui_width, view_I->ui_height, K_(0,0), K_(0,2), K_(1,2), 0.0, 0.0);
        break;
        default:
