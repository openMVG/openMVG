...
namespace openMVG
{
  ...
  void ImageXDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
    ...
    ImageHorizontalConvolution( img , kernel , out , border_mgmt ) ;
  }
   ...
   **/
  template< typename Image >
  void ImageYDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
    Vec3 kernel( -1.0, 0.0, 1.0) ; 
    ...
    ImageVerticalConvolution( img , kernel , out , border_mgmt ) ;
  }
   ...
   **/
  template< typename Image >
  void ImageSobelXDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
    ...
    ImageSeparableConvolution( img , kernel_horiz , kernel_vert , out , border_mgmt ) ; 
  }
   ...
   **/
  template< typename Image >
  void ImageSobelYDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
   ...
   **/
  template< typename Image >
  void ImageScharrXDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
    Vec3 kernel_horiz( -1.0, 0.0, 1.0) ;
   ...
   **/
  template< typename Image >
  void ImageScharrYDerivative( const Image & img , Image & out , const bool normalize = true , const EBorderManagement border_mgmt = BORDER_COPY ) 
  {
   ...
   **/
  template< typename Image >
  void ImageScaledScharrXDerivative( const Image & img , Image & out , const int scale , const bool bNormalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
   ...
   **/
  template< typename Image >
  void ImageScaledScharrYDerivative( const Image & img , Image & out , const int scale , const bool bNormalize = true , const EBorderManagement border_mgmt = BORDER_COPY )
  {
    /*
   ...
   **/
  template< typename Image >
  void ImageGaussianFilter( const Image & img , const double sigma , Image & out , const int k = 3 , const EBorderManagement border_mgmt = BORDER_COPY )
  {
