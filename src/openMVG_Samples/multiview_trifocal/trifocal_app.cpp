...
Display() 
{
  ...
  svgDrawer svg_stream(svg_w, svg_h);
...
DisplayDesiredInliers() 
{
  ...
  for (const auto &track_it: tracks_) {
    ...
    svg_stream << drawLine(
      feature_i.x(), feature_i.y(),
      feature_j.x(), feature_j.y() + images_[0].Height(),
      svgAttributes().stroke("lightblue", 1));
    svg_stream << drawLine(
      feature_i.x(), feature_i.y(),
      feature_j.x(), feature_j.y() + images_[0].Height(),
      svgAttributes().stroke("lightblue", 1));
