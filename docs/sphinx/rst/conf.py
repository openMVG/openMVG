...
project = u'openMVG'
copyright = u'2013, OpenMVG authors'
...
man_pages = [
    ('index', 'openmvg', u'openMVG Documentation',
     [u'Pierre MOULON & Bruno DUISIT'], 1)
]
...
texinfo_documents = [
  ('index', 'openMVG', u'openMVG Documentation',
   u'Pierre MOULON & Bruno DUISIT', 'openMVG', 'an open Multiple View Geometry library.',
   'Miscellaneous'),
]
...
epub_author = u'Pierre MOULON & Bruno DUISIT'
epub_publisher = u'Pierre MOULON & Bruno DUISIT'
epub_copyright = u'2013, Pierre MOULON & Bruno DUISIT'
